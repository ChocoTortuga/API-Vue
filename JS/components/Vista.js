            ...
            <div class="row justify-content-center">
                <div v-for="(item, index) in productos" :key="index" class="card list-group-item-warning text-center m-3" style="width: 18rem;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-warning">{{item.id}}</li>
                        <li class="list-group-item list-group-item-warning"><img :src="item.img" class="img-fluid"></li>
                        <li class="list-group-item list-group-item-warning">{{item.nombre}}</li>
                        <li class="list-group-item list-group-item-warning">{{item.plataforma}}</li>
                        <li class="list-group-item list-group-item-warning">{{item.genero}}</li>
                        <li class="list-group-item list-group-item-warning">{{item.estado}}</li>
                        <li class="list-group-item list-group-item-warning">{{item.precio}}</li>
